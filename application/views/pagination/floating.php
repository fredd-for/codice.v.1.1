...
<div class="pagination">
	...
	<?php if ($first_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($first_page)) ?>" rel="first"><?php echo __('Primero') ?></a>
	<?php else: ?>
		<?php echo __('Primero') ?>
	<?php endif ?>
	...
	<?php if ($next_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($next_page)) ?>" rel="next"><?php echo __('Siguiente') ?></a>
	<?php else: ?>
		<?php echo __('Siguiente') ?>
	<?php endif ?>

	<?php if ($last_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($last_page)) ?>" rel="last"><?php echo __('Ultimo') ?></a>
	<?php else: ?>
		<?php echo __('Ultimo') ?>
	<?php endif ?>
