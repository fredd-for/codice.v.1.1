...
class Controller_footer extends Controller_footertemplate{
    ...
    public function before() {
        ...
        //menu top de acuerdo al nivel
            ...
            $this->menus=$oNivel->menus($user->nivel);                        
        }
        parent::before();
    }
    public function after() {
        ...
        $this->template->submenu = View::factory('templates/submenu')->bind('smenus',$submenus)->set('titulo','Inicio');
        parent::after();
    }
