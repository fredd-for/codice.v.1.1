...
<link rel=File-List href="NOTA_archivos/filelist.xml">
<link rel=Edit-Time-Data href="NOTA_archivos/editdata.mso">
<!--[if !mso]>
<style>
...
<link rel=themeData href="NOTA_archivos/themedata.thmx">
<link rel=colorSchemeMapping href="NOTA_archivos/colorschememapping.xml">
<!--[if gte mso 9]><xml>
 <w:WordDocument>
...
p
 ...
 /* Page Definitions */
 @page
	{mso-footnote-separator:url("NOTA_archivos/header.php?ofi=<?php echo $s_oficina;?>&codigo=<?php echo $codigo;?>") fs;
	mso-footnote-continuation-separator:url("NOTA_archivos/header.php?ofi=<?php echo $s_oficina;?>&codigo=<?php echo $codigo;?>") fcs;
	mso-endnote-separator:url("NOTA_archivos/header.php?ofi=<?php echo $s_oficina;?>&codigo=<?php echo $codigo;?>") es;
	mso-endnote-continuation-separator:url("NOTA_archivos/header.php?ofi=<?php echo $s_oficina;?>&codigo=<?php echo $codigo;?>") ecs;}
@page Section1
	{size:612.1pt 792.1pt;
	margin:4.0cm 70.9pt 70.9pt 3.0cm;
	mso-header-margin:17.85pt;
	mso-footer-margin:22.7pt;
	mso-header:url("NOTA_archivos/header.php?ofi=<?php echo $s_oficina;?>&codigo=<?php echo $codigo;?>") h1;
	mso-footer:url("NOTA_archivos/header.php?ofi=<?php echo $s_oficina;?>&codigo=<?php echo $codigo;?>") f1;
	mso-paper-source:0;}
div.Section1
	{page:Section1;}
 /* List Definitions */
...
font-family:"Verdana","sans-serif"'>NOTA INTERNA</span></b></p>
