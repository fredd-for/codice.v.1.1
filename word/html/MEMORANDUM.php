...
<link rel=File-List href="MEMORANDUM_archivos/filelist.xml">
<link rel=Edit-Time-Data href="MEMORANDUM_archivos/editdata.mso">
<!--[if !mso]>
<style>
...
$resultado= mysql_query ($query, $conexion);	
	$res= mysql_fetch_object ($resultado);

$querynur = "select nur from hojas_ruta where codigo='$codigo'";
	$nurdoc=mysql_query($querynur, $conexion);
	$resnur=mysql_fetch_object($nurdoc);
	$nur=$resnur->nur;
?>
...
<link rel=themeData href="MEMORANDUM_archivos/themedata.thmx">
<link rel=colorSchemeMapping href="MEMORANDUM_archivos/colorschememapping.xml">
<!--[if gte mso 9]><xml>
 <w:WordDocument>
...
p
 ...
 /* Page Definitions */
 @page
	{mso-footnote-separator:url("MEMORANDUM_archivos/header.php?ofi=<?php echo $s_oficina;?>&codigo=<?php echo $codigo;?>") fs;
	mso-footnote-continuation-separator:url("MEMORANDUM_archivos/header.php?ofi=<?php echo $s_oficina;?>&codigo=<?php echo $codigo;?>") fcs;
	mso-endnote-separator:url("MEMORANDUM_archivos/header.php?ofi=<?php echo $s_oficina;?>&codigo=<?php echo $codigo;?>") es;
	mso-endnote-continuation-separator:url("MEMORANDUM_archivos/header.php?ofi=<?php echo $s_oficina;?>&codigo=<?php echo $codigo;?>") ecs;}
@page Section1
	{size:612.1pt 792.1pt;
	margin:4.0cm 70.9pt 70.9pt 3.0cm;
	mso-header-margin:17.85pt;
	mso-footer-margin:22.7pt;
	mso-header:url("MEMORANDUM_archivos/header.php?ofi=<?php echo $s_oficina;?>&codigo=<?php echo $codigo;?>") h1;
	mso-footer:url("MEMORANDUM_archivos/header.php?ofi=<?php echo $s_oficina;?>&codigo=<?php echo $codigo;?>") f1;
	mso-paper-source:0;}
div.Section1
	{page:Section1;}
 /* List Definitions */
...
font-family:"Verdana","sans-serif"'>MEMORANDUM</span></b></p>
